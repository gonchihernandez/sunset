...
proto.gooseai.CAIParameters = function (opt_data) {
  jspb.Message.initialize(
    ...
    -1,
    null,
    proto.gooseai.CAIParameters.oneofGroups_,
  );
};
...
proto.gooseai.CAIParameters.prototype.getParametersCase = function () {
  return /** @type {proto.gooseai.CAIParameters.ParametersCase} */ (
    jspb.Message.computeOneofCase(
      this,
      proto.gooseai.CAIParameters.oneofGroups_[0],
    )
  );
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.gooseai.CAIParameters.prototype.toObject = function (
    opt_includeInstance,
  ) {
 ...
 * @return {!proto.gooseai.CAIParameters}
 */
proto.gooseai.CAIParameters.deserializeBinaryFromReader = function (
  msg,
  reader,
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value = /** @type {!proto.gooseai.CAIParameters.ModelMetadata} */ (
          reader.readEnum()
        );
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.CAIParameters.serializeBinaryToWriter = function (
  message,
  writer,
) {
  var f = undefined;
  f = /** @type {!proto.gooseai.CAIParameters.ModelMetadata} */ (
    jspb.Message.getField(message, 1)
  );
  if (f != null) {
    writer.writeEnum(1, f);
...
proto.gooseai.CAIParameters.prototype.getModelMetadata = function () {
  return /** @type {!proto.gooseai.CAIParameters.ModelMetadata} */ (
    jspb.Message.getFieldWithDefault(this, 1, 0)
  );
};
  ...
  proto.gooseai.ImageParameters.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        caiParameters:
          (f = msg.getCaiParameters()) &&
          proto.gooseai.CAIParameters.toObject(includeInstance, f),
        adapter:
          (f = msg.getAdapter()) &&
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 11:
        ...
        reader.readMessage(
          value,
          proto.gooseai.CAIParameters.deserializeBinaryFromReader,
        );
